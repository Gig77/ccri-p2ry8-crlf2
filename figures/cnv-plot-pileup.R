...
samples = rbind(samples, setNames(data.frame("DL2D", "IKZF1", "WES", stringsAsFactors = F), names(samples)))
samples = rbind(samples, setNames(data.frame("DL2R", "IKZF1", "MLPA", stringsAsFactors = F), names(samples)))
samples = rbind(samples, setNames(data.frame("108D", "IKZF1", "WES", stringsAsFactors = F), names(samples)))
samples = rbind(samples, setNames(data.frame("108R", "IKZF1", "MLPA", stringsAsFactors = F), names(samples)))
samples = rbind(samples, setNames(data.frame("HV57D", "IKZF1", "WES", stringsAsFactors = F), names(samples)))
samples = rbind(samples, setNames(data.frame("HV57R", "IKZF1", "WES", stringsAsFactors = F), names(samples)))
samples = rbind(samples, setNames(data.frame("DS10898D", "IKZF1", "MLPA", stringsAsFactors = F), names(samples)))
samples = rbind(samples, setNames(data.frame("DS10898R", "IKZF1", "WES", stringsAsFactors = F), names(samples)))
...
samples = rbind(samples, setNames(data.frame("HV80D", "IKZF1", "WES", stringsAsFactors = F), names(samples)))
...
samples = rbind(samples, setNames(data.frame("B36R", "IKZF1", "WES", stringsAsFactors = F), names(samples)))
...
cnv.mlpa <- rbind(cnv.mlpa, setNames(data.frame("DL2D", "chr7", 50444209, 50459583, 1, stringsAsFactors = F), names(cnv.mlpa)))
cnv.mlpa <- rbind(cnv.mlpa, setNames(data.frame("DL2R", "chr7", 50444209, 50459583, 1, stringsAsFactors = F), names(cnv.mlpa)))
cnv.mlpa <- rbind(cnv.mlpa, setNames(data.frame("108D", "chr7", 50444209, 50459583, 1, stringsAsFactors = F), names(cnv.mlpa)))
cnv.mlpa <- rbind(cnv.mlpa, setNames(data.frame("108R", "chr7", 50444209, 50459583, 1, stringsAsFactors = F), names(cnv.mlpa)))
cnv.mlpa <- rbind(cnv.mlpa, setNames(data.frame("HV57D", "chr7", 50444209, 50455178, 1, stringsAsFactors = F), names(cnv.mlpa)))
cnv.mlpa <- rbind(cnv.mlpa, setNames(data.frame("HV57R", "chr7", 50444209, 50455178, 1, stringsAsFactors = F), names(cnv.mlpa)))
cnv.mlpa <- rbind(cnv.mlpa, setNames(data.frame("HV80D", "chr7", 50444209, 50607882, 1, stringsAsFactors = F), names(cnv.mlpa)))
cnv.mlpa <- rbind(cnv.mlpa, setNames(data.frame("HV80R", "chr7", 50444209, 50607882, 1, stringsAsFactors = F), names(cnv.mlpa)))
cnv.mlpa <- rbind(cnv.mlpa, setNames(data.frame("DS10898D", "chr7", 50366858, 50455178, 1, stringsAsFactors = F), names(cnv.mlpa)))
cnv.mlpa <- rbind(cnv.mlpa, setNames(data.frame("DS10898R", "chr7", 50366858, 50455178, 1, stringsAsFactors = F), names(cnv.mlpa)))
cnv.mlpa <- rbind(cnv.mlpa, setNames(data.frame("GI8R", "chr7", 50366858, 50455178, 1, stringsAsFactors = F), names(cnv.mlpa)))
cnv.mlpa <- rbind(cnv.mlpa, setNames(data.frame("B36R", "chr7", 50344212, 50473084, 1, stringsAsFactors = F), names(cnv.mlpa)))
cnv.mlpa <- rbind(cnv.mlpa, setNames(data.frame("KT14158D", "chr7", 50444209, 50459583, 1, stringsAsFactors = F), names(cnv.mlpa)))
...
for (i in 1:nrow(regions)) {
  ...
  plotTracks(c(list(ideogram.track, axis.track, gene.track), cntracks), 
             sizes=c(0.05, 0.1, 0.05, rep((1-(0.05+0.1+0.05))/nrow(samples.region), nrow(samples.region))),
